...
import { UploadCloud, FileText, CheckCircle2, XCircle, Loader2, X, FilePlus2 } from "lucide-react"
 ...
 *
 * Shown as a compact prompt card; the actual dropzone lives inside a dialog
 * opened by the "Upload Report" button, so the profile area doesn't lead
 * with a big empty dropzone by default.
 */
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-[#2e3742]">Upload Report</DialogTitle>
            <DialogDescription>Add a lab report as a PDF. Max {formatBytes(MAX_PDF_BYTES)}.</DialogDescription>
          </DialogHeader>
